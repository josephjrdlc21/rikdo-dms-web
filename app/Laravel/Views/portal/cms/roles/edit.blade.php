            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="input_role" class="form-control" placeholder="Role" name="role"  value="{{$role->name}}">
                    ...
                    <div class="form-group">
                        ...
                        {!! html()->select('status', $statuses, value($role->status), ['id' => "input_status"])->class('form-control selectric') !!}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-4">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input permission-checkbox" type="checkbox" name="permissions[]" value="{{$permission->name}}" id="permission-{{$permission->name}}" data-module="{{$module_name}}" {{$role->permissions->contains($permission->id) ? 'checked' : ''}}>
