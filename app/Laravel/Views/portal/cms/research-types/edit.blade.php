            ...
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="input_type" class="form-control" placeholder="Type" name="type"  value="{{$research_type->type}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="input_max_chapter" class="form-control" placeholder="Max Chapter" name="max_chapter"  value="{{$research_type->max}}" min="0" step="1">
