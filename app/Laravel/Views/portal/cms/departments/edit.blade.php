            ...
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="input_dept_code" class="form-control" placeholder="Code" name="dept_code"  value="{{$department->dept_code}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="input_dept_name" class="form-control" placeholder="Name" name="dept_name"  value="{{$department->dept_name}}">
