            ...
            <div class="card-body">
                <form method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="input_course_code" class="form-control" placeholder="Code" name="course_code"  value="{{$course->course_code}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="input_course_name" class="form-control" placeholder="Name" name="course_name"  value="{{$course->course_name}}">
