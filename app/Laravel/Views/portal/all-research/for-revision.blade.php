    ...
    <form method="GET" action="">
        <div class="card-header">
            ...
            <div class="card-header-action">
                ...
                <a href="{{route('portal.all_research.for_revision')}}" class="btn btn-sm btn-secondary" style="border-radius: 0.25rem !important;">Reset Filter</a>
            </div>
        </div>
        <div class="card-body">
            <div class="row">
                        ...
                        <td>
                            <div class="btn-group mb-2">
                                ...
                                <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; transform: translate3d(0px, 29px, 0px); top: 0px; left: 0px; will-change: transform;">
                                    @if($auth->canAny(['portal.all_research.view'], 'web'))         
                                    <a class="dropdown-item" href="{{route('portal.all_research.show', [$research->id])}}">View Details</a>
                                    @endif
                                    @if($auth->canAny(['portal.all_research.delete'], 'web'))         
